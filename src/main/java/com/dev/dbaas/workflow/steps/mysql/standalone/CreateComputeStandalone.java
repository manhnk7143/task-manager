...
public class CreateComputeStandalone implements StepBody {
    ...
    public ExecutionResult run(StepExecutionContext context) throws Exception {
        ...
        JSONObject checkPrerequisitesStandalone = origin.optJSONObject(CheckPrerequisitesStandalone.class.getSimpleName());
        JSONObject generateCloudInitStandalone = origin.optJSONObject(GenerateCloudInitStandalone.class.getSimpleName());
        String orgId = checkPrerequisitesStandalone.optString("orgId");
        String instanceId = checkPrerequisitesStandalone.optString("instanceId");
        String regionId = checkPrerequisitesStandalone.optString("regionId");
        String projectId = checkPrerequisitesStandalone.optString("projectId");

        String glanceImageId = checkPrerequisitesStandalone.optString("glanceImageId");
        String flavorId = checkPrerequisitesStandalone.optString("flavorId");
        String datastore = checkPrerequisitesStandalone.optString("datastore");
