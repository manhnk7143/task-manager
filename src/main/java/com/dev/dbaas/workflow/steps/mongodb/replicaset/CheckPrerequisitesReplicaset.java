package com.dev.dbaas.workflow.steps.mongodb.replicaset;
...
public class CheckPrerequisitesReplicaset implements StepBody {

    private static final Logger LOGGER = Logger.getLogger(CheckPrerequisitesReplicaset.class);

    public CheckPrerequisitesReplicaset() {
    }
    ...
    public ExecutionResult run(StepExecutionContext context) throws Exception {
        ...
        JSONObject input = origin.optJSONObject(CheckPrerequisitesReplicaset.class.getSimpleName());
        ...
        JSONArray secondaryComputeIds = input.optJSONArray("secondaryComputeIds");
        ...
        try {
            ...
            if (subnet == null) {
                LOGGER.error("Not found VPC : " + tag);
                throw new Exception();
            }
