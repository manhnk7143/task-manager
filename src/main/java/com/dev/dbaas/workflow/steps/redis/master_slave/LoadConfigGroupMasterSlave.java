package com.dev.dbaas.workflow.steps.redis.master_slave;
...
public class LoadConfigGroupMasterSlave implements StepBody {

    private static final Logger LOGGER = Logger.getLogger(LoadConfigGroupMasterSlave.class);

    public LoadConfigGroupMasterSlave() {
    }
    ...
    public ExecutionResult run(StepExecutionContext context) throws Exception {
        ...
        JSONObject input = origin.optJSONObject(LoadConfigGroupMasterSlave.class.getSimpleName());
