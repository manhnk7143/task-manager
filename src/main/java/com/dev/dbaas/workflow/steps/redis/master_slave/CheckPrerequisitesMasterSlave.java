...
public class CheckPrerequisitesMasterSlave implements StepBody {

    private static final Logger LOGGER = Logger.getLogger(CheckPrerequisitesMasterSlave.class);

    public CheckPrerequisitesMasterSlave() {
    }
