...
public class LoadConfigGroupReplicaset implements StepBody {

    private static final Logger LOGGER = Logger.getLogger(LoadConfigGroupReplicaset.class);

    public LoadConfigGroupReplicaset() {
    }
    ...
    public ExecutionResult run(StepExecutionContext context) throws Exception {
        ...
        JSONObject input = origin.optJSONObject(LoadConfigGroupReplicaset.class.getSimpleName());
