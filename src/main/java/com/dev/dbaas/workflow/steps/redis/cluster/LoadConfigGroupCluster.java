...
public class LoadConfigGroupCluster implements StepBody {

    private static final Logger LOGGER = Logger.getLogger(LoadConfigGroupCluster.class);

    public LoadConfigGroupCluster() {
    }
