...
public class CreateComputeSlave0Cluster implements StepBody {

    private static final Logger LOGGER = Logger.getLogger(CreateComputeSlave0Cluster.class);

    public CreateComputeSlave0Cluster() {
    }
    ...
    public ExecutionResult run(StepExecutionContext context) throws Exception {
        ...
        JSONObject input = origin.optJSONObject(CreateComputeSlave0Cluster.class.getSimpleName());
        ...
        String userData = origin.optJSONObject(GenerateCloudInitSlave0Cluster.class.getSimpleName()).optString("userData");
        String cinderVolumeId = origin.optJSONObject(CreateVolumeSlave0Cluster.class.getSimpleName()).optString("cinderVolumeId");
        int volumeSize = origin.optJSONObject(CreateVolumeSlave0Cluster.class.getSimpleName()).optInt("volumeSize");
