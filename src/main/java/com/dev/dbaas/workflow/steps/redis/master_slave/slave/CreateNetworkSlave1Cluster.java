...
public class CreateNetworkSlave1Cluster implements StepBody {

    private static final Logger LOGGER = Logger.getLogger(CreateNetworkSlave1Cluster.class);

    public CreateNetworkSlave1Cluster() {
    }
