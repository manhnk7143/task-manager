...
public class LoadConfigGroupReplicasetUndo implements StepBody {

    private static final Logger LOGGER = Logger.getLogger(LoadConfigGroupReplicasetUndo.class);

    public LoadConfigGroupReplicasetUndo() {
    }
    ...
    public ExecutionResult run(StepExecutionContext context) throws Exception {
        ...
        JSONObject input = origin.optJSONObject(LoadConfigGroupReplicasetUndo.class.getSimpleName());
