...
public class CreateVolumeMasterCluster implements StepBody {

    private static final Logger LOGGER = Logger.getLogger(CreateVolumeMasterCluster.class);

    public CreateVolumeMasterCluster() {
    }
    ...
    public ExecutionResult run(StepExecutionContext context) throws Exception {
        ...
        JSONObject input = origin.optJSONObject(CreateVolumeMasterCluster.class.getSimpleName());
