package com.dev.dbaas.workflow.steps.kafka.cluster.undo;

import com.dev.dbaas.utils.datastore.OpenstackResource;
import com.dev.dbaas.workflow.steps.kafka.cluster.CheckPrerequisitesCluster;
...
public class CheckPrerequisitesClusterUndo implements StepBody {

    private static final Logger LOGGER = Logger.getLogger(CheckPrerequisitesClusterUndo.class);

    public CheckPrerequisitesClusterUndo() {
    }
