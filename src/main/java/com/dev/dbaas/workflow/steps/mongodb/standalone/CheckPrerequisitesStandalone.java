...
public class CheckPrerequisitesStandalone implements StepBody {

    private static final Logger LOGGER = Logger.getLogger(CheckPrerequisitesStandalone.class);

    public CheckPrerequisitesStandalone() {
    }
    ...
    public ExecutionResult run(StepExecutionContext context) throws Exception {
        ...
        JSONObject input = origin.optJSONObject(CheckPrerequisitesStandalone.class.getSimpleName());
