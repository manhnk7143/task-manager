...
public class CreateVolumeSlave1Cluster implements StepBody {

    private static final Logger LOGGER = Logger.getLogger(CreateVolumeSlave1Cluster.class);

    public CreateVolumeSlave1Cluster() {
    }
    ...
    public ExecutionResult run(StepExecutionContext context) throws Exception {
        ...
        JSONObject input = origin.optJSONObject(CreateVolumeSlave1Cluster.class.getSimpleName());
