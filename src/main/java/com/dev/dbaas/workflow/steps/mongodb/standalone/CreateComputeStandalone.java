...
public class CreateComputeStandalone implements StepBody {
    ...
    public ExecutionResult run(StepExecutionContext context) throws Exception {
        ...
        try {
            ...
            LOGGER.info("Creating Nova Server with parameters: computeName=" + computeName
                    + ", regionId=" + regionId
                    + ", zoneName=" + compute.getZoneName()
                    + ", keyPair=" + keyPair
                    + ", glanceImageId=" + glanceImageId
                    + ", flavorId=" + flavorId
            ...
            Server server = OSContextManager.getInstance().createNovaServer(datastore, computeName, regionId, compute.getZoneName(), keyPair,
                    glanceImageId, flavorId, userDataEncrypted, cinderVolumeId, volumeSize, networkIds);
