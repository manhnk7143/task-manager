...
public class CreateVolumePrimaryReplicaset implements StepBody {

    private static final Logger LOGGER = Logger.getLogger(CreateVolumePrimaryReplicaset.class);

    public CreateVolumePrimaryReplicaset() {
    }
    ...
    public ExecutionResult run(StepExecutionContext context) throws Exception {
        ...
        JSONObject input = origin.optJSONObject(CreateVolumePrimaryReplicaset.class.getSimpleName());
        ...
        try {
            ...
            Volume volume = OSContextManager.getInstance().createVolume(datastore, regionId, volumeName,
                    volumeSize, "", compute.getZoneName());
