...
public class CreateVolumeSecondaryReplicaset implements StepBody {

    private static final Logger LOGGER = Logger.getLogger(CreateVolumeSecondaryReplicaset.class);

    public CreateVolumeSecondaryReplicaset() {
    }
    ...
    public ExecutionResult run(StepExecutionContext context) throws Exception {
        ...
        JSONObject input = origin.optJSONObject(CreateVolumeSecondaryReplicaset.class.getSimpleName());
