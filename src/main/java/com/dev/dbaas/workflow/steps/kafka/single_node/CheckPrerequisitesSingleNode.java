...
public class CheckPrerequisitesSingleNode implements StepBody {

    private static final Logger LOGGER = Logger.getLogger(CheckPrerequisitesSingleNode.class);
    ...
    public ExecutionResult run(StepExecutionContext context) throws Exception {
        ...
        LOGGER.info("Input CheckPrerequisitesSingleNode : " + input.toString());
        ...
        try {
            ...
            if (vpc == null) {
                ...
                instance.setUpdatedAt(LocalDateTime.now());
                InstanceManager.update(instance);
                throw new Exception(instance.getMessage());
            }
            ...
            TbInstance instance = InstanceManager.findById(instanceId);
            instance.setMessage("check prerequisites error: " + e.getMessage());
            instance.setStatus(Constaint.STATUS_ERROR);
            instance.setUpdatedAt(LocalDateTime.now());
            InstanceManager.update(instance);
            throw e;
