...
public class GenerateCloudInitSlave1Cluster implements StepBody {

    private static final Logger LOGGER = Logger.getLogger(GenerateCloudInitSlave1Cluster.class);

    public GenerateCloudInitSlave1Cluster() {
    }
    ...
    public ExecutionResult run(StepExecutionContext context) throws Exception {
        ...
        JSONObject input = origin.optJSONObject(GenerateCloudInitSlave1Cluster.class.getSimpleName());
        ...
        String ipAddress = origin.optJSONObject(CreateNetworkSlave1Cluster.class.getSimpleName()).optString("ipAddress");
