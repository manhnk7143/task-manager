package com.dev.dbaas.worker.processor.control.mongodb;
...
public class CreateMongodbReplicasetProcessor implements ProcessorBase<ControlJob> {

    private static final Logger LOGGER = Logger.getLogger(CreateMongodbReplicasetProcessor.class);
    ...
    public boolean process(ControlJob job) throws Exception {
        ...
        String workFlowId = WorkFlowManager.getInstance().startCreateMongodbReplicaset(input);
