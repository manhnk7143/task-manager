package com.dev.dbaas.worker.processor.control.redis;
...
public class CreateRedisMasterSlaveProcessor implements ProcessorBase<ControlJob> {

    private static final Logger LOGGER = Logger.getLogger(CreateRedisMasterSlaveProcessor.class);
    ...
    public boolean process(ControlJob job) throws Exception {
        ...
        String workFlowId = WorkFlowManager.getInstance().startCreateRedisMasterSlave(input);
