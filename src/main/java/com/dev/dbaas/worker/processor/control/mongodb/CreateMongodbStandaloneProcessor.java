...
public class CreateMongodbStandaloneProcessor implements ProcessorBase<ControlJob> {

    private static final Logger LOGGER = Logger.getLogger(CreateMongodbStandaloneProcessor.class);
    ...
    public boolean process(ControlJob job) throws Exception {
        ...
        String workFlowId = WorkFlowManager.getInstance().startCreateMongodbStandalone(input);
