...
public class CreateRedisStandaloneProcessor implements ProcessorBase<ControlJob> {

    private static final Logger LOGGER = Logger.getLogger(CreateRedisStandaloneProcessor.class);
    ...
    public boolean process(ControlJob job) throws Exception {
        ...
        String workFlowId = WorkFlowManager.getInstance().startCreateRedisStandalone(input);
